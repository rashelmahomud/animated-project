...
function ParallaxText({ children, baseVelocity = 100 }) {
  ...
  return (
    <div className="parallax overflow-hidden whitespace-nowrap flex text-4xl sm:text-5xl md:text-6xl lg:text-7xl uppercase font-extrabold py-4 px-0">
      ...
      >
        <span className="block mr-8 text-indigo-600 dark:text-indigo-400 drop-shadow-lg">
          {children}{" "}
        </span>
        <span className="block mr-8 text-purple-600 dark:text-purple-400 drop-shadow-lg">
          {children}{" "}
        </span>
        <span className="block mr-8 text-pink-600 dark:text-pink-400 drop-shadow-lg">
          {children}{" "}
        </span>
        <span className="block mr-8 text-red-600 dark:text-red-400 drop-shadow-lg">
          {children}{" "}
        </span>
      </motion.div>
    </div>
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100 dark:from-gray-900 dark:to-gray-800 font-inter text-gray-900 dark:text-gray-100 overflow-x-hidden">
      ...
      <section className="relative z-10 py-10 px-4 md:px-8 lg:px-16 flex flex-col items-center justify-center text-center">
        ...
        <p className="text-lg sm:text-xl md:text-2xl max-w-3xl mb-12 text-gray-700 dark:text-gray-300">
          Experience fluid animations driven by scroll velocity using Framer
          Motion. This example showcases a responsive parallax text effect that
      ...
      <div className="py-24 px-4 md:px-8 lg:px-16 text-center">
        ...
        <p className="text-lg sm:text-xl max-w-2xl mx-auto text-gray-600 dark:text-gray-400 mb-8">
          This section provides ample vertical space, allowing you to scroll and
          observe how the parallax text above reacts to your scrolling speed and
          direction. Framer Motion handles the intricate physics, making the
          animation smooth and interactive.
        </p>

        <ul className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto justify-center items-center gap-2 p-0 m-0 list-none relative">
          {order.map((backgroundColor) => (
            ...
            >
              <div className="p-6 rounded-xl shadow-lg hover:shadow-xl transition-shadow duration-300 text-white">
            <h3 className="text-2xl font-semibold mb-3 ">Smooth Animations</h3>
            <p className="">
      ...
      <div className="py-16 px-4 md:px-8 lg:px-16 text-center bg-gray-100 dark:bg-gray-800">
        <p className="text-gray-600 dark:text-gray-400">
          Explore more possibilities with Framer Motion and create stunning web
          animations.
        </p>
      </div>
    </div>
